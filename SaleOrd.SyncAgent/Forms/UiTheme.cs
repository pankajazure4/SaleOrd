...
// Ported from SalesPush.SyncAgent's Forms/UiTheme.cs — identical palette and
// helpers, kept in sync deliberately so both desktop agents look like one
// product family. Plain flat-design colors rather than a full custom-control
// library — this is a code-only WinForms project (no Designer.cs anywhere),
// so anything fancier than flat colors + icon glyphs would be a lot of GDI+
// owner-draw work for little payoff.
